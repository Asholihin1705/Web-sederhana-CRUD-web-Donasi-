...
$(document).ready(function () {
    ...
    <div class="container">
        <h2><img src="img/home.png" width="40px">Homepage Admin</h2>
        <div class="isi">
            <h1>SELAMAT DATANG</h1>
            <P>Selamat Bekerja! Gunakan sistem ini untuk kepentingan Sosial Organisasi dengan baik.<p>
            <p>Tingkatkan Rasa Kekeluargaan di dalam Organisasi Kita</p>
            <p>Salam Hormat dari Kami Tim Support</p>
        </div>
    </div>
